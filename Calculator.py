...
btnSq = Button(calc, text="sqr", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
...
btnpi = Button(calc, text="pi", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
...
btn2Pi = Button(calc, text="2pi", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
...
btnMod = Button(calc, text="Mod", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
                command=added_value.mathsPM).grid(row=3, column=6, pady=1)
...
btnlog1p = Button(calc, text="log1p", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
                  command=added_value.loglp).grid(row=5, column=5, pady=1)
...
btnlgama = Button(calc, text="lgama", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
...
editmenu.add_command(label="Help View")
